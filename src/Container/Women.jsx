        ...
        return(
            <div className="women-header">
                ...
                {this.state.womenWorkouts.map(workout => (
                    ...
                    <div className="row-1">
                            <a href={workout[6].imageUrl} target="_blank"><img className="page-icons" src={abs} alt="" />Core</a>

                            <a href={workout[8].imageUrl} target="_blank"><img className="page-icons" src={top} alt="" />Upper Body</a>
                        </div>

                        <div className="row-2">
                            <a href={workout[7].imageUrl} target="_blank"><img className="page-icons" src={legsFemme} alt="" />Legs</a>

                            <a href={workout[9].imageUrl} target="_blank"><img className="page-icons" src={freeWeights} alt="" />Free Weights</a>
                        </div>


                        <div className="row-3">
                            <a href={workout[10].imageUrl} target="_blank"><img className="page-icons" src={powerlift} alt="" />Powerlift</a>

                            <a href={workout[11].imageUrl} target="_blank"><img className="page-icons" src={jogging} alt="" />Cardio</a>
                        </div>
                        <div className="foot">
